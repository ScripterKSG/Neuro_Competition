This repository contains the data files and notebooks used in a Kaggle competition by Rice University. The goal to predict whether a pair of neurons (one axon and one dendrite)
